        ...
        <div className=' md:py-5 items-center flex justify-center flex-col '>
          <div className=' rounded-2xl border-gray-500/90 border-2 '>
            <div className='pt-3 flex flex-col items-center justify-center'>
              ...
              <div className='text-xs text-[#131921] pt-5'>Buy with us? <Link to='/user-signin' className='text-[#CC0000] font-semibold'>Create User Account</Link></div>
            </div>
            <form className='mx-4' onSubmit={(e) => { submitHandler(e) }}>
              <div className=' gap-5'>
                <label>
                  <div>
                    <p className='text-[#131921] font-semibold py-3'><span className='text-[#CC0000]'>*</span> Admin Image</p>
                ...
                <label>
                  <p className='text-[#131921] font-semibold py-3'><span className='text-[#CC0000]'>*</span> Business Name</p>
                ...
                <label>
                  <p className='text-[#131921] font-semibold py-3'><span className='text-[#CC0000]'>*</span> Admin Name</p>
              ...
              <label>
                <div>
                  <p className='text-[#131921] font-semibold py-3'><span className='text-[#CC0000]'>*</span> Number</p>
              ...
              <h1 className='pt-5 text-[#131921] font-semibold'><span className='text-[#CC0000]'>*</span> Address</h1>
              <div className=" md:flex md:gap-5">
                <label>
                  <div>
                    <p className='text-[#131921] font-semibold py-3'><span className='text-[#CC0000]'>*</span> Street</p>
                ...
                <label>
                  <div className=''>
                    <p className='text-[#131921] font-semibold py-3'><span className='text-[#CC0000]'>*</span> City</p>
              ...
              <div className=" md:flex md:gap-5">
                <label>
                  <div>
                    <p className='text-[#131921] font-semibold py-3'><span className='text-[#CC0000]'>*</span> State</p>
                ...
                <label>
                  <div className=''>
                    <p className='text-[#131921] font-semibold py-3'><span className='text-[#CC0000]'>*</span> Zip Code</p>
              ...
              <div className=" md:flex md:gap-5">
                <label>
                  <div>
                    <p className='text-[#131921] font-semibold py-3'><span className='text-[#CC0000]'>*</span> Country</p>
              ...
              <label>
                <div>
                  <p className='text-[#131921] font-semibold py-3'><span className='teCC0000]'>*</span> Business Type</p>
              ...
              <label>
                <div>
                  <p className='text-[#131921] font-semibold py-3'><span className='text-[#CC0000]'>*</span> Role</p>
            ...
            <div className='w-full flex justify-center items-center'>
              <div className='text-xs text-[#131921] py-5'>Already have an account? {' '} <Link to='/admin-login' className='text-[#CC0000] font-semibold'>Login</Link></div>
            </div>
          </div>
        </div>
      </div>
