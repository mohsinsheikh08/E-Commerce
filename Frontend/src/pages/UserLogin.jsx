        ...
        <div className=' md:py-5 items-center flex justify-center flex-col '>
          <div className=' rounded-2xl border-gray-500/90 border-2 '>
            <div className='pt-3 flex flex-col items-center justify-center'>
              ...
              <div className='text-xs text-[#131921] pt-5'>Login your account <Link to='/admin-login' className='text-[#CC0000] font-semibold'>Seller Account</Link></div>
            </div>
            ...
            <div className='w-full flex justify-center items-center'>
              <div className='text-xs text-[#131921] py-5'>If you do not have account {' '} <Link to='/user-signin' className='text-[#CC0000] font-semibold'>Sign up</Link></div>
            </div>
          </div>
        </div>
      </div>
