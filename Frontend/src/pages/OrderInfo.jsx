      ...
      <div className=' md:py-5 items-center flex justify-center flex-col '>
        <div className=' rounded-2xl border-gray-500/90 border-2 '>
          <div className='pt-3 flex flex-col items-center justify-center'>
            <h1 className='text-4xl font-semibold'>Post <span className='text-[#CC0000]'>Orders</span></h1>
            ...
            <form className='mx-4' onSubmit={(e) => { submitHandler(e) }}>
              <label>
                <div>
                  <p className='text-[#131921] font-semibold py-3'><span className='text-[#CC0000]'>*</span> Payment Method</p>
              ...
              <div className='w-full py-5 flex justify-center items-center'>
                <button className="bg-[#CC0000] text-[#ffff] font-semibold py-2 px-3 rounded-lg" type='submit'>{!isLoading ? "Order Place " : "Placing"}</button>
              </div>
            </form>
          </div>
        </div>
